                    ...
                    <div class="app-footer__items">
                        <div class="app-footer__item">
                            <div class="app-footer__body">
                                <h3 class="app-footer__title">IZZI SOFT</h3>
...
PT. IZZI MITRA SOLUSINDO didukung oleh infrastruktur yang sangat baik dengan sumberdaya manusia yang profesional, berpengalaman, bersertifikat internasional dan menerapkan teknologi terkini. Dengan berbekal semangat, inovasi, kreatifitas serta networking, PT. IZZI MITRASOLUSINDO sanggup bersaing di bisnis Teknologi Informasi. </div>
                        ...
                        <div class="app-footer__item">
                            <div class="app-footer__body">
                                <h3 class="app-footer__title">Link Bantuan</h3>
                                <div class="app-footer__content">
...
class="fas fa-chevron-right"></i>Cara Mulai Memesan?</a></li>
                            ...
                            <div class="app-footer__body">
                                ...
                                <div class="app-footer__content">
                                    <div class="app-footer__contact-phone">
                                        <a target="_blank" href="tel:+021 2761 3349" class="app-footer__phone"> + 021 2761 3349</a><br>
                                        <a target="_blank" href="https://wa.me/628192001233"><i class="fab fa-whatsapp"></i> : +62 8192-001-233</a>
                                    ...
                                    <a target="_blank" href="https://www.google.com/maps/place/izzi-soft+official/@-6.4121091,106.8488769,17z/data=!3m1!4b1!4m5!3m4!1s0x2e69ebb0d4a785b7:0x7d0053f952c236b9!8m2!3d-6.4121091!4d106.8510656" class="app-footer__get-location-link"> Alamat Kami di Maps</a>
                        ...
                        <div class="app-footer__item">
                            <div class="app-footer__body">
                                <h3 class="app-footer__title">Info Terbaru</h3>
                                <div class="app-footer__content">
