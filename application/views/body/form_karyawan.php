				...
				<div class="panel panel-default">
					<div class="panel-heading"><svg class="glyph stroked male user "><use xlink:href="#stroked-male-user"/></svg>
						<?php if ($this->uri->segment(2) =="edit") {?>
							<a href="#" style="text-decoration:none">Edit Data Client</a></div>
						<?php }else{ ?>
					...
					<div class="form-group">
						...
						<select required="" class="form-control select2" name="id_institusi" id="id_institusi">
							<?php if ($this->uri->segment(2) =="edit") {?>
					...
					<a href="<?php echo base_url();?>client/karyawan_list"  class="btn btn-default">Cancel</a>
				    </div>
