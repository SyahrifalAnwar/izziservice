...
<a href="#" class="list-group-item">Judul : &nbsp;<?php echo $problem_summary;?></a>
<a href="#" class="list-group-item">Deskripsi : &nbsp;<?php echo $problem_detail;?></a>
<?php if($userfile == NULL || $userfile == ''){ ?>
<?php }else{ ?>
<div class="list-group-item"> Foto : <a class="btn btn-info" target="blank" href="<?php echo base_url('uploads/').$userfile;?>"><i class="glyphicon glyphicon-paperclip"></i></a></div>
<?php } ?>
</div>
