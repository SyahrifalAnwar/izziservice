...
<a href="<?php echo base_url();?>superuser/add" style="text-decoration:none">Add Data Staff</a></div>
					<div class="panel-body">
						<table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true"  data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    ...
						    <tr>
						       ...
						       <!--  <th data-field="bagian" data-sortable="true">Division</th> -->
                           ...
                           <?php $no = 0; foreach($datakaryawan as $row) : $no++;?>
						     <tr>
						        ...
						        <td> 
<a class="ubah btn btn-primary btn-xs" href="<?php echo base_url();?>superuser/edit/<?php echo $row->nik;?>"><span class="glyphicon glyphicon-edit" ></span></a>
