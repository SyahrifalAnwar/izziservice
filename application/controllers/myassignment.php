...
function __construct(){
 ...
 function ticket_detail($id)
 {
        ...
        $sql = "SELECT A.progress, A.status, A.problem_summary,A.problem_detail, A.reported, A.userfile, D.nama, C.id_kategori, A.id_ticket, A.tanggal, B.nama_sub_kategori, C.nama_kategori
                FROM ticket A 
